      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Decentralized prediction markets for betting on real-world events with on-chain settlement.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            ...
            <li>Place bets on outcomes</li>
            <li>Track market movement</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>✓ Decentralized prediction markets</li>
            <li>✓ On-chain settlement</li>
            <li>✓ Real-time odds</li>
            <li>✓ Multiple market types</li>
